...
export class App implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.msalService.handleRedirectObservable().subscribe({
      ...
      error: (error) => {
        // e.g. the user cancelled consent, or Entra ID returned an error
        // in the redirect response. The guard will treat them as
        // unauthenticated and route them back to login.
